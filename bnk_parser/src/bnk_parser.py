...
bank_name = "banks"
src_file = f"D:/MOD/audio/{bank_name}.bnk.xml"
parsed_data_file = f"D:/MOD/audio/{bank_name}.txt"
parsed_data_file_tsv = f"D:/MOD/audio/{bank_name}.tsv"
...
class CAkDialogueEvent:
    ...
    def get_children(self):
        children_list = []
        for k, v in dialogue_event.children.items():
...
with open(parsed_data_file_tsv, "w") as file:
